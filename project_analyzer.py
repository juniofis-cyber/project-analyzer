...
st.image("Chromis_logo_principal.png", width=100)
...
st.info("ℹ️ O Chromis utiliza exclusivamente o **canal vermelho** (red channel) do scanner e preserva o **bit-depth original**. Para scanners em 16-bit, os valores de ADC devem estar na faixa de **~27.000 a ~52.000**.")

tipo_filme = st.radio("**Tipo de Filme**", ["EBT3", "EBT4"], horizontal=True)
metodologia = st.radio("**Modo de Análise**", ["Filme Único", "Múltiplos Filmes", "Análise Gamma"], horizontal=True)
st.markdown("---")
...
# ============================================================
st.markdown("---")
st.caption("FilmIQ v2.4 | Dosimetria com Filmes Radiocrômicos EBT3/EBT4 | Análise Gamma TG-218")
