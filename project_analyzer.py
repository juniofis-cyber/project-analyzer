...
# ==================== ANÁLISE GAMMA (REESCRITA v11) ====================
    ...
    # Badge de versão para confirmar deploy correto
    col_v1, col_v2 = st.columns([1, 4])
    with col_v1:
        st.success("v2.1")
    with col_v2:
        st.caption("ROI por clique + tamanho em mm | Clique na imagem para definir centro, ajuste largura/altura, aplique.")
    ...
    if roi_mode == "Clique na imagem":
        st.session_state['gg_roi_mode'] = "Clique na imagem"
    ...
    # ==========================================================
        ...
        st.session_state['gg_roi_mode'] = "Automático (threshold de dose)"
...
# ============================================================
st.markdown("---")
st.caption("Project Analyzer v2.1 | Análise de Filmes Radiocrômicos EBT3/EBT4 | TG-218 Gamma Analysis")
