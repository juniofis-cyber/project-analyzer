...
# Modo de Analise (Filme Unico / Multiplos Filmes) + Analise Gamma separado
tipo_filme = st.radio("**Tipo de Filme**", ["EBT3", "EBT4"], horizontal=True, key="tipo_filme_v2")
metodologia = st.radio("**Metodologia**", ["Filme Único", "Múltiplos Filmes"], horizontal=True, key="metod_v2")

# Botao separado para Analise Gamma
gamma_mode = st.checkbox("Ativar Modo Analise Gamma", value=False, key="gamma_check")
if gamma_mode:
    metodologia = "Análise Gamma"
st.markdown("---")

with st.sidebar:
    st.header("Configuracoes")
    dpi = st.number_input("DPI do Scanner", 1, 2400, 50)
    if metodologia == "Filme Único":
...
elif metodologia == "Múltiplos Filmes":
...
# ============================================================
st.markdown("---")
st.caption("Chromis v3.0 | Dosimetria com Filmes Radiocrômicos EBT3/EBT4 | Análise Gamma TG-218")
