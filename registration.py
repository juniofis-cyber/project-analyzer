...
def auto_register_dose_maps(
    ...
    # Reamostrar para grade comum (usar a resolução mais grossa)
    target_res = max(res_film_mm, res_tps_mm)
    film_rs, tps_rs = _resample_to_common(film_norm, tps_norm, res_film_mm, res_tps_mm, target_res)
